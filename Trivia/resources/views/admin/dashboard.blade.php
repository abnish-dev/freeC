                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    ...
                    <div class="icon">
                      ...
                      <a href="{{route('users.index')}}" class="small-box-footer">Users panel <i class="fa fa-arrow-circle-right"></i></a>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    ...
                    <div class="inner-div">
                    <a href="{{route('question.index')}}" class="small-box-footer">Listing page <i class="fa fa-arrow-circle-right"></i></a></div>
